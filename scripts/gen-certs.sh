...
gen_key evil_ca
openssl req -new -x509 -days 365 -key evil_ca.key -out evil_ca.crt -subj "/C=US/ST=IL/L=Champaign/O=Pyre Inc./OU=Interview/CN=evilservice"

gen_key server
gen_cert server root_ca

gen_key client_untrusted
gen_key client_read
gen_key client_write
gen_key client_unauthorized
gen_key client_unauthorized_permissions

gen_cert client_untrusted evil_ca
